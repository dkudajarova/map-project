...
export default function QualityDashboardPage() {
  ...
  return <main className="quality-page">
    ...
    <section className="quality-card" aria-labelledby="metadata-heading">
      <div className="quality-section-heading"><div><p className="quality-section-number">02</p><h2 id="metadata-heading">Displayable metadata by building age</h2></div><p>Architect · builder · building name · Wikipedia link</p></div>
    ...
    <section className="quality-card" aria-labelledby="hail-heading">
      <div className="quality-section-heading"><div><p className="quality-section-number">03</p><h2 id="hail-heading">Hail footprint mapping</h2></div><p>{formatCount(data.hail.eligibleTotal)} mapping-eligible records</p></div>
      ...
      </div><p className="quality-method-note">Mapping-eligible records exclude {formatCount(data.hail.excludedTotal)} razed, cross-reference, or otherwise ineligible Hail rows. “No footprint” includes explicit reviewer no-match decisions.</p>
    </section>
